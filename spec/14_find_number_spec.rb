...
describe FindNumber do
  ...
  describe '#make_guess' do
    ...
    # explained above.
    subject(:number_guessing) { double("random_number", value:8)}
  ...
  describe '#game_over?' do
    context 'when guess and random_number are equal' do
      ...
      subject(:number_guessing){ double("random_number", value:3) }

      subject(:game_guessing){described_class.new(0,9,number_guessing, 3)}
      it 'is game over' do
        #gameover = game_guessing.game_over?
    ...
    context 'when guess and random_number are not equal' do
      ...
      subject(:game_guessing){described_class.new(0,9,number_guessing, 4)}
