...
describe NumberGame do
  ...
  describe '#player_turn' do
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        ...
        incorrect_value2 = "12"
        correct_value = "4"
        allow(game_loop).to receive(:player_input).and_return(incorrect_value1,incorrect_value2,correct_value)
      end
  ...
  describe '#final_message' do
    ...
    context 'when count is 4 and over' do
      ...
      it 'outputs correct phrase' do
        msg = "That was hard. It took you 4 guesses!\n"
        expect{game_one.final_message}.to output(msg).to_stdout
      end
    end
  end
end
